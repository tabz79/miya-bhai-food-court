          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-amber-500">{brandData.tagline}</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <a href={brandData.social.facebook} className="text-gray-400 hover:text-amber-500 transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href={brandData.social.instagram} className="text-gray-400 hover:text-amber-500 transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href={brandData.social.twitter} className="text-gray-400 hover:text-amber-500 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href={brandData.social.youtube} className="text-gray-400 hover:text-amber-500 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start">
                <Phone className="w-4 h-4 mr-2 mt-1 text-amber-500" />
                <div>
              ...
              <div className="flex items-start">
                <Mail className="w-4 h-4 mr-2 mt-1 text-amber-500" />
                <div>{brandData.contact.email}</div>
              </div>
              <div className="flex items-start">
                <MapPin className="w-4 h-4 mr-2 mt-1 text-amber-500" />
                <div>HITEC City, Madhapur,<br />Hyderabad - 500081</div>
              </div>
              <div className="flex items-start">
                <Clock className="w-4 h-4 mr-2 mt-1 text-amber-500" />
